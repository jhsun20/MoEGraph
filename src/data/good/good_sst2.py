...
class GOODSST2(InMemoryDataset):
    ...
    def __init__(self, root: str, domain: str = 'length', shift: str = 'no_shift', subset: str = 'train', transform=None,
    ...
    @staticmethod
    def load(dataset_root: str, domain: str = 'length', shift: str = 'no_shift', generate: bool = False):
        r"""
